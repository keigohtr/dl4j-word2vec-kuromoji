...
import com.apitore.fruitbasket.pomegranate.tokenization.tokenizer.KuromojiNeologdTokenizer;


public class KuromojiNeologdTokenizerFactory implements TokenizerFactory {
  ...
  public Tokenizer create(String toTokenize) {
    ...
    KuromojiNeologdTokenizer ret = new KuromojiNeologdTokenizer(toTokenize);
